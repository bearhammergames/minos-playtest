// RETIRED 2026-07-05: frozen — agent-CLI playtesting is the bench going forward.
// This Monte-Carlo sim (and its 6 scripted policies + golden gate) is no longer a
// routine gate. Kept (not deleted); MAY be revisited once, shortly before the
// commercial launch. Logic below is unchanged.
// =============================================================================
